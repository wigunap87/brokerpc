					<div class="cr-bottom">
						<div class="crb-box" id="box-small1">
							<div class="bbox-head">
								<div class="bbxh-left">Tambah Category</div>
							...
							<form method="post" action="<?php echo base_url(); ?>category/addcategory_process" name="add-category" id="add-category" enctype="multipart/form-data" data-toggle="validator">
