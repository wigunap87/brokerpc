<?php foreach($show_saham as $sgal) : ?>
					<div class="cr-bottom">
						<div class="crb-box" id="box-small1">
							<div class="bbox-head">
								<div class="bbxh-left">Edit Saham - <?php echo $sgal->saham_title; ?></div>
							...
							<form method="post" action="<?php echo base_url(); ?>saham/editsaham_process" name="add-saham" id="add-saham" enctype="multipart/form-data" data-toggle="validator">
							<div class="bbox-cont" id="box-cont1">
								
								<input type="hidden" name="getid" value="<?php echo $sgal->id_saham_record; ?>" />
								<div class="fieldspage">
									<div class="fieldpage-title">Title<font color="red">*</font></div>
									<div class="fieldpage-info">
										<input type="text" name="title" class="input-form" value="<?php echo $sgal->saham_title; ?>" maxlength="100" required/>
									</div>
									<div class="clear"></div>
								</div>
								...
								<div class="fieldpage">
									...
									<div class="fieldpage-info">
										<input type="text" name="code" class="input-form" value="<?php echo $sgal->saham_code; ?>" maxlength="100" required/>
									</div>
									<div class="clear"></div>
								</div>
								...
								<div class="fieldspage">
									...
									<div class="fieldpage-info">
										<select name="status" class="input-select" required>
											<option value="<?php echo $sgal->saham_status; ?>" selected><?php echo $sgal->saham_status; ?></option>
