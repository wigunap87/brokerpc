$(document).ready(function() {
	...
	$('#datepicker-example15').Zebra_DatePicker({
        always_visible: $('#opencal2')
    });
	
	$('#datepicker-example19').Zebra_DatePicker({
        always_visible: $('#opencal3'),
		view: 'years',
		format: 'Y'
    });
	
	$('#datepicker-example20').Zebra_DatePicker({
        always_visible: $('#opencal4'),
		view: 'years',
		format: 'Y'
    });
	...
	$('#datepicker-example18').Zebra_DatePicker({
        always_visible: $('#opencal2')
    });
